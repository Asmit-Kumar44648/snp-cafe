  ...
  return (
    <section id="home" ref={container} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0E0000]" data-section="hero">
      ...
      <div className="absolute inset-0 z-10 overflow-hidden pointer-events-none">
        <div className="floating-item absolute top-1/4 left-[10%] w-32 h-32 bg-[url('/assets/images/pizza_margherita.jpg')] bg-cover rounded-full shadow-[0_24px_80px_rgba(156,5,18,0.4)] opacity-80 mix-blend-luminosity border border-[#EFEACD]/10" />
        <div className="floating-item absolute bottom-1/3 right-[15%] w-40 h-40 bg-[url('/assets/images/snp_gallery_pizza_box.jpg')] bg-cover rounded-full shadow-[0_24px_80px_rgba(156,5,18,0.4)] opacity-80 mix-blend-luminosity border border-[#EFEACD]/10" />
      </div>
